...
import {BackgroundIcon, BorderIcon, StretchedIcon} from "~/plugins/image-master/svg/icons";
...
export default class Tunes {
  ...
  render(toolData) {
    ...
    tunes.forEach(tune => {
      console.log('tune.icontune.icontune.icontune.icontune.icontune.icon')
      console.log(tune.icon)
